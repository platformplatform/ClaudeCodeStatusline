...
case "$cmd" in
    *"git commit"*) echo "⚠️ CRITICAL: NEVER proactively commit or suggest committing. Changes MUST always be reviewed BEFORE you commit. Only commit when explicitly instructed to." >&2 ;;
esac
